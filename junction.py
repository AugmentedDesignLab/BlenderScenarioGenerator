...
class junction:
    ...
    def create_3d_object(self):
        ...
        if not valid:
            ...
            id_obj = helper.get_new_id_opendrive(self.context)
            mesh.name = 'junction_area_' + str(id_obj)
            obj = bpy.data.objects.new(mesh.name, mesh)
            obj.matrix_world = matrix_world
            helper.link_object_opendrive(self.context, obj)
            ...
            helper.select_activate_object(self.context, obj)
    ...
    def create_stencil(self):
        ...
        helper.select_activate_object(self.context, self.stencil)
    ...
    def update_stencil(self):
        ...
        if valid:
            helper.replace_mesh(self.stencil, mesh)
